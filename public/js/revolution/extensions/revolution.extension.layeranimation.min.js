                ...
                void 0 !== j &&
                  ...
                  f
                    ? k
                      ...
                      : (l || "out" === e.animdirection || d.timeline.play(h),
                        (("visible" == o && "keep" !== p) ||
                          ("keep" === p && k === !0) ||
                          ("visible" == o && void 0 === k)) &&
          ...
          c.hover(
            ...
            function (a) {
              ...
              j &&
                ...
                i.svg &&
                  punchgs.TweenLite.to(i.svg, h.speed / 1e3, g.idlesvg.anim));
            }
          );
        }
          ...
          function (a, d, e, f, g, h, i) {
            ...
            (k.layer = c),
              ...
              "leftstage" === k.eventtype &&
                (punchgs.TweenLite.set(f, { visibility: "hidden" }),
                (g.animdirection = "out"),
                (g.visibleelement = !1),
          ...
          jQuery.each(e, function (a, b) {
            ...
            c &&
              ...
              void 0 != g &&
                ((g = g.replace(/\(R\)/, "")),
                ("rotationX" != f && "rX" != f) ||
                  (d.anim.rotationX = k(g, d.anim.rotationX) + "deg"),
                ("rotationY" != f && "rY" != f) ||
                  (d.anim.rotationY = k(g, d.anim.rotationY) + "deg"),
                ("rotationZ" != f && "rZ" != f) ||
                  (d.anim.rotation = k(g, d.anim.rotationZ) + "deg"),
                ("scaleX" != f && "sX" != f) ||
                  (d.anim.scaleX = k(g, d.anim.scaleX)),
                ("scaleY" != f && "sY" != f) ||
                  (d.anim.scaleY = k(g, d.anim.scaleY)),
                ("opacity" != f && "o" != f) ||
                  (d.anim.opacity = k(g, d.anim.opacity)),
                0 === d.anim.opacity && (d.anim.autoAlpha = 0),
                (d.anim.opacity = 0 == d.anim.opacity ? 1e-4 : d.anim.opacity),
                ("skewX" != f && "skX" != f) ||
                  (d.anim.skewX = k(g, d.anim.skewX)),
                ("skewY" != f && "skY" != f) ||
                  (d.anim.skewY = k(g, d.anim.skewY)),
                "x" == f && (d.anim.x = k(g, d.anim.x)),
                "y" == f && (d.anim.y = k(g, d.anim.y)),
                "z" == f && (d.anim.z = k(g, d.anim.z)),
                ("transformOrigin" != f && "tO" != f) ||
                  (d.anim.transformOrigin = g.toString()),
                ("transformPerspective" != f && "tP" != f) ||
                  (d.anim.transformPerspective = parseInt(g, 0)),
